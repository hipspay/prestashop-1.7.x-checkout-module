...
class hipscheckoutvalidationModuleFrontController extends ModuleFrontController
{
    ...
    public function setMedia()
    {
        ...
        $this->context->controller->registerJavascript(
                'hipscheckout', __PS_BASE_URI__ . 'modules/hipscheckout/views/js/hipscheckout.js'
        );

        $this->context->controller->registerStylesheet(
                'hipscheckout', __PS_BASE_URI__ . 'modules/hipscheckout/views/css/hipscheckout.css'
        );
    }
    ...
    public function postProcess()
    {
        ...
        $this->setTemplate('module:hipscheckout/views/templates/front/validation.tpl');
