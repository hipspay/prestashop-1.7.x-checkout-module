...
class HipsCheckout extends PaymentModule
{
    ...
    public function hookDisplayHeader()
    {
        ...
        //$this->context->controller->registerJavascript(
        //        'hipscheckout', 'modules/' . $this->name . '/views/js/statesManagement.js'
        //);
        $this->context->controller->registerStylesheet(
                'hipscheckout', 'modules/' . $this->name . '/views/css/hipscheckout.css'
        );
    }
    ...
    private function prepareAdminVars()
    {
        ...
        $checkInstalledCart = $this->fileCheckLines('/override/controllers/front/OrderController.php', '/override/controllers/front/OrderController.php', array('12-19'), $ps_version);
