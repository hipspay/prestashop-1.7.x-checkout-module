        ...
        <div class="override_content">
            <div class="override_block">
                <div class="override_class">
                    ...
                    <span  class="{if $checkInstalledCart['/override/controllers/front/OrderController.php']['file_installed']}file_installed{else}file_not_installed{/if}">/hipscheckout/override_{$aw_ps_version|floatval}/controllers/front/OrderController.php</span>
                    <br/>
                    {l s='to' mod='hipscheckout'}<br/>
                    /override/controllers/front/
                </div>
                <div class="override_lines">
                    {if $checkInstalledCart['/override/controllers/front/OrderController.php']['file_not_found']}
                        Lines <span class="{if $checkInstalledCart['/override/controllers/front/OrderController.php']['12-19']}file_installed{else}file_not_installed{/if}">#12-19<span>
                    {else}
            ...
            <div class="override_block">
                <div class="override_class">
                    {l s='Copy' mod='hipscheckout'}<br/>
                    <span  class="{if $checkInstalledPaymentModule['/override/classes/PaymentModule.php']['file_installed']}file_installed{else}file_not_installed{/if}">/hipscheckout/override_{$aw_ps_version|floatval}/classes/PaymentModule.php</span>
                    <br/>
                    {l s='to' mod='hipscheckout'}<br/>
                    /override/classes/
                </div>
